...
class OMRMng {
	...
	void makeAnswer() {
		...
		System.out.println("학생 답안 : " + Arrays.toString(me));
	}

	// 2.정답 출력하기
	void showAnswer() {
		System.out.println("모범 답안 : " + Arrays.toString(omr));
	}
...
public class 메서드01_OMR {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 예) omr = {1, 3, 4, 2, 5} me = {1, 1, 4, 4, 3} 정오표 = {O, X, O, X, X} 성적 = 40점
		 */
